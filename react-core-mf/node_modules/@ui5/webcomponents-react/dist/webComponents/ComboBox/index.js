 ...
 */
const ComboBox = withWebComponent('ui5-combobox', ['accessibleName', 'accessibleNameRef', 'filter', 'placeholder', 'value', 'valueState'], ['disabled', 'loading', 'noTypeahead', 'readonly', 'required', 'showClearIcon'], ['icon', 'valueStateMessage'], ['change', 'input', 'selection-change']);
