...
interface CustomListItemPropTypes extends CustomListItemAttributes, Omit<CommonProps, keyof CustomListItemAttributes | 'children' | 'deleteButton' | 'onDetailClick'> {
    /**
