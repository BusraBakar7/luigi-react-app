...
interface DatePickerPropTypes extends DatePickerAttributes, Omit<CommonProps, keyof DatePickerAttributes | 'valueStateMessage' | 'onChange' | 'onInput' | 'onValueStateChange'> {
    /**
