...
interface DateRangePickerPropTypes extends DateRangePickerAttributes, Omit<CommonProps, keyof DateRangePickerAttributes | 'valueStateMessage' | 'onChange' | 'onInput' | 'onValueStateChange'> {
    /**
