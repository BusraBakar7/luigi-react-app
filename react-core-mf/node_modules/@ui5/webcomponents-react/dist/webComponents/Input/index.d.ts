...
interface InputPropTypes extends InputAttributes, Omit<CommonProps, keyof InputAttributes | 'children' | 'icon' | 'valueStateMessage' | 'onChange' | 'onInput' | 'onSuggestionItemPreview' | 'onSuggestionItemSelect'> {
    /**
