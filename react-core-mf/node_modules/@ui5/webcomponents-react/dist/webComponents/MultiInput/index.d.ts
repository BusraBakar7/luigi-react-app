...
import type { IInputSuggestionItem, InputSuggestionItemPreviewEventDetail, InputSuggestionItemSelectEventDetail } from '@ui5/webcomponents/dist/Input.js';
...
interface MultiInputPropTypes extends MultiInputAttributes, Omit<CommonProps, keyof MultiInputAttributes | 'children' | 'icon' | 'tokens' | 'valueStateMessage' | 'onChange' | 'onInput' | 'onSuggestionItemPreview' | 'onSuggestionItemSelect' | 'onTokenDelete' | 'onValueHelpTrigger'> {
    /**
