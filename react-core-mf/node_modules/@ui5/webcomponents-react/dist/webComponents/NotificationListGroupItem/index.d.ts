...
interface NotificationListGroupItemPropTypes extends NotificationListGroupItemAttributes, Omit<CommonProps, keyof NotificationListGroupItemAttributes | 'actions' | 'children' | 'onClose' | 'onToggle'> {
    /**
