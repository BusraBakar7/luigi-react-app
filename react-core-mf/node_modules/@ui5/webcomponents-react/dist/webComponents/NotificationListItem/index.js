 ...
 */
const NotificationListItem = withWebComponent('ui5-li-notification', ['busyDelay', 'priority', 'titleText', 'wrappingType'], ['busy', 'read', 'selected', 'showClose'], ['actions', 'avatar', 'footnotes'], ['close']);
