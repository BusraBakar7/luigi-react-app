...
interface SelectMenuOptionPropTypes extends SelectMenuOptionAttributes, Omit<CommonProps, keyof SelectMenuOptionAttributes | 'children' | 'deleteButton' | 'onDetailClick'> {
    /**
