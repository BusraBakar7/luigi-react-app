 ...
 */
const SelectMenuOption = withWebComponent('ui5-select-menu-option', ['accessibleName', 'displayText', 'highlight', 'tooltip', 'type', 'value'], ['disabled', 'navigated', 'selected'], ['deleteButton'], ['detail-click']);
