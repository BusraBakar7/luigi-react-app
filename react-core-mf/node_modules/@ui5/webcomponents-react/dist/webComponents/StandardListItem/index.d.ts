...
interface StandardListItemPropTypes extends StandardListItemAttributes, Omit<CommonProps, keyof StandardListItemAttributes | 'children' | 'deleteButton' | 'imageContent' | 'onDetailClick'> {
    /**
