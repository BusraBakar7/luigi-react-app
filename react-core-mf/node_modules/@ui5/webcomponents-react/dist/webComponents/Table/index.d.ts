...
interface TablePropTypes extends TableAttributes, Omit<CommonProps, keyof TableAttributes | 'children' | 'columns' | 'onLoadMore' | 'onPopinChange' | 'onRowClick' | 'onSelectionChange'> {
    /**
