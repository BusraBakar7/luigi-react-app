...
import { BarDesign, ButtonDesign, FlexBoxDirection, FlexBoxJustifyContent, MessageBoxActions, MessageBoxTypes, TableMode, TitleLevel, ToolbarStyle } from '../../enums/index.js';
import { ACTIVE, ALL, BASIC, CANCEL, FIELD, FIELDS_BY_ATTRIBUTE, FILTER_DIALOG_RESET_WARNING, FILTERS, GROUP_VIEW, HIDE_VALUES, LIST_VIEW, MANDATORY, OK, RESET, SEARCH_FOR_FILTERS, SHOW_VALUES, VISIBLE, VISIBLE_AND_ACTIVE } from '../../i18n/i18n-defaults.js';
...
export const FilterDialog = props => {
  ...
  return /*#__PURE__*/React.createElement(FilterBarDialogContext.Provider, {
    value: {
  ...
  }, /*#__PURE__*/createPortal( /*#__PURE__*/React.createElement(Dialog, {
    open: open,
    ref: dialogRef,
  ...
  }, isListView && renderChildren()), !isListView && renderGroups()), portalContainer ?? document.body), showRestoreButton && messageBoxOpen && /*#__PURE__*/createPortal( /*#__PURE__*/React.createElement(MessageBox, {
    open: true,
    type: MessageBoxTypes.Warning,
    actions: [MessageBoxActions.OK, MessageBoxActions.Cancel],
    onClose: handleMessageBoxClose,
    "data-component-name": "FilterBarDialogResetMessageBox"
  }, i18nBundle.getText(FILTER_DIALOG_RESET_WARNING)), document.body));
};