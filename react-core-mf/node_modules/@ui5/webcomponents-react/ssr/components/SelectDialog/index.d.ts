...
import type { ButtonDomRef, ButtonPropTypes, DialogDomRef, DialogPropTypes, IconDomRef, InputDomRef, ListDomRef, ListPropTypes, StandardListItemDomRef } from '../../webComponents/index.js';
export interface SelectDialogPropTypes extends Omit<DialogPropTypes, 'header' | 'headerText' | 'footer' | 'children' | 'state'>, Pick<ListPropTypes, 'growing' | 'onLoadMore'> {
    /**
