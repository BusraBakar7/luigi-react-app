...
import { debounce, useI18nBundle, useIsomorphicLayoutEffect, useStylesheet, useSyncRef } from '@ui5/webcomponents-react-base';
...
const Toolbar = /*#__PURE__*/forwardRef((props, ref) => {
  ...
  const toolbarClasses = clsx(classNames.outerContainer, toolbarStyle === ToolbarStyle.Clear && classNames.clear, active && classNames.active, design === ToolbarDesign.Solid && classNames.solid, design === ToolbarDesign.Transparent && classNames.transparent, design === ToolbarDesign.Info && classNames.info, className);
