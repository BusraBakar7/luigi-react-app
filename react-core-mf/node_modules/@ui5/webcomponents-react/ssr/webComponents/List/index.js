 ...
 */
const List = withWebComponent('ui5-list', ['accessibleName', 'accessibleNameRef', 'accessibleRole', 'busyDelay', 'footerText', 'growing', 'growingButtonText', 'headerText', 'mode', 'noDataText', 'separators'], ['busy', 'indent'], ['header'], ['item-click', 'item-close', 'item-delete', 'item-toggle', 'load-more', 'selection-change'], () => import('@ui5/webcomponents/dist/List.js'));
