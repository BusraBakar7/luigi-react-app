...
import type { MenuBeforeCloseEventDetail, MenuBeforeOpenEventDetail, MenuItemClickEventDetail, MenuItemFocusEventDetail } from '@ui5/webcomponents/dist/Menu.js';
...
interface MenuPropTypes extends MenuAttributes, Omit<CommonProps, keyof MenuAttributes | 'children' | 'onAfterClose' | 'onAfterOpen' | 'onBeforeClose' | 'onBeforeOpen' | 'onItemClick' | 'onItemFocus'> {
    /**
