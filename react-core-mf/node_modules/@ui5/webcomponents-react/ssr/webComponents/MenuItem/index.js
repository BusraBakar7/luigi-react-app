 ...
 * @abstract
 */
const MenuItem = withWebComponent('ui5-menu-item', ['accessibleName', 'additionalText', 'busyDelay', 'icon', 'text', 'tooltip'], ['busy', 'disabled', 'startsSection'], [], [], () => import('@ui5/webcomponents/dist/MenuItem.js'));
