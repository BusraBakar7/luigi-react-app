 ...
 */
const MultiComboBox = withWebComponent('ui5-multi-combobox', ['accessibleName', 'accessibleNameRef', 'filter', 'placeholder', 'value', 'valueState'], ['allowCustomValues', 'disabled', 'noTypeahead', 'readonly', 'required', 'showClearIcon', 'showSelectAll'], ['icon', 'valueStateMessage'], ['change', 'input', 'open-change', 'selection-change'], () => import('@ui5/webcomponents/dist/MultiComboBox.js'));
