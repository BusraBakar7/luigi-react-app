...
interface PopoverPropTypes extends PopoverAttributes, Omit<CommonProps, keyof PopoverAttributes | 'children' | 'footer' | 'header' | 'onAfterClose' | 'onAfterOpen' | 'onBeforeClose' | 'onBeforeOpen'> {
    /**
