...
export const Expandable = props => {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, columnIndex === 0 &&
  /*#__PURE__*/
  // todo rowProps should be applied to the whole row, not just the cell. We should consider refactoring this.
  React.createElement(React.Fragment, null, row.canExpand || subComponentExpandable ? /*#__PURE__*/React.createElement("span", {
