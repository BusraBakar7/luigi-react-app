...
import { debounce, deprecationNotice, enrichEventWithDetails, useI18nBundle, useIsomorphicId, useIsomorphicLayoutEffect, useIsRTL, useStylesheet, useSyncRef } from '@ui5/webcomponents-react-base';
...
const AnalyticalTable = /*#__PURE__*/forwardRef((props, ref) => {
  ...
  const tableClasses = clsx(classNames.table, GlobalStyleClasses.sapScrollBar, withNavigationHighlight && classNames.hasNavigationIndicator, showVerticalEndBorder && classNames.showVerticalEndBorder);
  ...
  }), loading && rows?.length > 0 && /*#__PURE__*/React.createElement(LoadingComponent, {
    style: {
      width: `${totalColumnsWidth}px`
    }
  }), loading && rows?.length === 0 && /*#__PURE__*/React.createElement(TablePlaceholder, {
    columns: visibleColumns,
    rows: minRows,
    style: noDataStyles
  }), !loading && rows?.length === 0 && /*#__PURE__*/React.createElement(NoDataComponent, {
    noDataText: noDataTextLocal,
    className: classNames.noDataContainer,
    style: noDataStyles
  }), rows?.length > 0 && tableRef.current && /*#__PURE__*/React.createElement(VirtualTableBodyContainer, {
