...
export declare const resolveMessageGroups: (children: ReactElement<MessageItemPropTypes>[]) => [string, ReactElement<MessageItemPropTypes, string | React.JSXElementConstructor<any>>[]][];
/**
