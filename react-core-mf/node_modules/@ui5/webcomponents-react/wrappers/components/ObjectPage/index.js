...
import { debounce, deprecationNotice, enrichEventWithDetails, ThemingParameters, useStylesheet, useSyncRef } from '@ui5/webcomponents-react-base';
...
const ObjectPage = /*#__PURE__*/forwardRef((props, ref) => {
  ...
  useEffect(() => {
    if (showTitleInHeaderContent && !deprecationNoticeDisplayed.current) {
      deprecationNotice('showTitleInHeaderContent', 'showTitleInHeaderContent is deprecated and will be removed with the next major release.');
  ...
  const objectPageClasses = clsx(classNames.objectPage, GlobalStyleClasses.sapScrollBar, className, mode === ObjectPageMode.IconTabBar && classNames.iconTabBarMode);
  const {
    onScroll: _0,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    "aria-hidden": true
  }), placeholder ? placeholder : sections, /*#__PURE__*/React.createElement("div", {
    style: {
      height: `${sectionSpacer}px`
    },
    "aria-hidden": true
  })), footer && mode === ObjectPageMode.IconTabBar && !sectionSpacer && /*#__PURE__*/React.createElement("div", {
