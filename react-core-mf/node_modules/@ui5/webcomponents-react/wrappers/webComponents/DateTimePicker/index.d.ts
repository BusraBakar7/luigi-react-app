...
interface DateTimePickerPropTypes extends DateTimePickerAttributes, Omit<CommonProps, keyof DateTimePickerAttributes | 'valueStateMessage' | 'onChange' | 'onInput' | 'onValueStateChange'> {
    /**
