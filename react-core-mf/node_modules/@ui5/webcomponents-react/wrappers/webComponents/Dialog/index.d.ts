...
interface DialogPropTypes extends DialogAttributes, Omit<CommonProps, keyof DialogAttributes | 'children' | 'footer' | 'header' | 'onAfterClose' | 'onAfterOpen' | 'onBeforeClose' | 'onBeforeOpen'> {
    /**
