...
interface ResponsivePopoverPropTypes extends ResponsivePopoverAttributes, Omit<CommonProps, keyof ResponsivePopoverAttributes | 'children' | 'footer' | 'header' | 'onAfterClose' | 'onAfterOpen' | 'onBeforeClose' | 'onBeforeOpen'> {
    /**
