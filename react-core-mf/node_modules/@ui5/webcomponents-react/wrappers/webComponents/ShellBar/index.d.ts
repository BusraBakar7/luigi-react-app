...
import type { ShellBarAccessibilityAttributes, ShellBarAccessibilityRoles, ShellBarAccessibilityTexts, ShellBarCoPilotClickEventDetail, ShellBarLogoClickEventDetail, ShellBarMenuItemClickEventDetail, ShellBarNotificationsClickEventDetail, ShellBarProductSwitchClickEventDetail, ShellBarProfileClickEventDetail, ShellBarSearchButtonEventDetail } from '@ui5/webcomponents-fiori/dist/ShellBar.js';
...
interface ShellBarPropTypes extends ShellBarAttributes, Omit<CommonProps, keyof ShellBarAttributes | 'children' | 'logo' | 'menuItems' | 'profile' | 'searchField' | 'startButton' | 'onCoPilotClick' | 'onLogoClick' | 'onMenuItemClick' | 'onNotificationsClick' | 'onProductSwitchClick' | 'onProfileClick' | 'onSearchButtonClick'> {
    /**
