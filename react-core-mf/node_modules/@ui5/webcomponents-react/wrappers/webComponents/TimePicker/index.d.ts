...
import type { TimePickerBaseChangeEventDetail, TimePickerBaseInputEventDetail } from '@ui5/webcomponents/dist/TimePickerBase.js';
...
interface TimePickerPropTypes extends TimePickerAttributes, Omit<CommonProps, keyof TimePickerAttributes | 'valueStateMessage' | 'onChange' | 'onInput'> {
    /**
